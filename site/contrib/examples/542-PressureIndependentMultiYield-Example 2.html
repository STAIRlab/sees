# PressureIndependentMultiYield-Example 2
...
mass density set cohesion 30 ; set peakShearStrain 0.1 ; set E1 90000.0
...
integration parameter set pi 3.1415926535 ; set inclination 0 ; set
unitWeightX [expr ($massDen-$fluidDen)*9.81*sin($inclination/180.0*$pi)]
;# buoyant unit weight in X direction set unitWeightY [expr
...
rayleigh 0.0 0.0 0.000 0. integrator Newmark $gamma [expr
