...
<p>This commnand allows the user to construct an NDFiberSection object.
...
in 3D (N, Mz, Vy, My, Vz, and T).</p>
<p>The NDFiberSection works with any NDMaterial via wrapper classes that
...
appropriate fiber stress conditions.</p>
<p>The command to generate NDFiberSection object contains in <strong>{
...
<hr />
<p>&lt;uml&gt; NDFiberSection o- NDFiber &lt;/uml&gt;</p>
<hr />
