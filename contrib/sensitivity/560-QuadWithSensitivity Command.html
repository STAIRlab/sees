...
```tcl
element quadWithSensitivity $eleTag $iNode $jNode $kNode
...
<tr class="odd">
<td><p><code class="parameter-table-variable">thick</code></p></td>
...
<tr class="odd">
<td><p><code class="parameter-table-variable">matTag</code></p></td>
<td><p>tag associated with previously-defined NDMaterial
object.</p></td>
</tr>
<tr class="even">
<td><p><code class="parameter-table-variable">pressure</code></p></td>
<td><p>surface pressure (set temporarily equal to zero for DDM-based
sensitivity analysis).</p></td>
</tr>
<tr class="odd">
<td><p><code class="parameter-table-variable">rho</code></p></td>
