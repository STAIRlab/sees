...
```tcl
element dispBeamColumnWithSensitivity $eleTag $iNode
...
<tr class="odd">
<td><p><code class="parameter-table-variable">numIntgrPts</code></p></td>
...
<tr class="odd">
<td><p><code class="parameter-table-variable">transfTag</code></p></td>
