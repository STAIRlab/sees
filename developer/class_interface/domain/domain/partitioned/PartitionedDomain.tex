...
{\em DomainPartitioner \&getPartitioner(void) const;} 
...
{\em PartitionedDomain(DomainPartitioner \&thePartitioner); } 
...
{\em virtual bool setCurrentLoadCase(int LCtag);} 
